...
def vec (x, y):
    """ returns a pair of coordinates defining the vector (coordinates of the end point of the vector),
    the coordinates of the vector starting point coincide with the origin of the coordinate system (0, 0) """
    return sub (y, x)
...
# ================================================= ======================================
# Functions responsible for calculating polyline smoothing
# ================================================= =======================================
